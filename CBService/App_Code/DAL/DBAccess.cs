...
public class DBAccess : IDisposable
{
    ...
    public DBAccess()
    {
        ...
        strConnectionString = Utils.GetConnectionString();
    ...
    {
        cmd.CommandType = CommandType.StoredProcedure;
        strConnectionString = Utils.GetConnectionString(connectionStringName);
        SqlConnection cnn = new SqlConnection();
        cnn.ConnectionString = strConnectionString;
        cmd.Connection = cnn;
    }
    public DBAccess(CommandType commandType)
        : this()
    {
