...
{
    public partial class BCTHSPTNForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                //Lấy dữ liệu
                BaoCaoDAO.NapBCTHSPTN(nguonDL,maDV, cboLoaiBC.SelectedIndex, sdNgayBD.Value, sdNgayKT.Value,strLoaiMay, ref TongSoBG, ref listTH);
                ...
                string strLoaiDM = cboDonVi.Text;               
                rptParam = new ReportParameter("prmNhombc", strLoaiDM.Split('.')[1].ToUpper());
                rptParamList.Add(rptParam);
                ...
                rptParamList.Add(rptParam);
                FormHelper.ShowReport(reportViewer1, "RptTHSPTN", "BaoCaoDS", listTH, rptParamList);
