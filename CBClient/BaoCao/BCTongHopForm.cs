...
{
    public partial class BCTongHopForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        string loaiBC = string.Empty;
        string cacThang = string.Empty;
        public BCTongHopForm()
        {
            ...
            string[] arRayDMs = new string[] { "ĐM 1245", "ĐM 1760" };
            cboLoaiDM.Items.AddRange(arRayDMs);
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string loaiDM = "DinhMucNL1245";
                if (cboLoaiDM.SelectedIndex == 1)
                    loaiDM = "DinhMucNL1760";
                int TongSoBG = 0;
                List<BCTongHopInfo> listTH = new List<BCTongHopInfo>();                             
                    //Lấy dữ liệu
                BaoCaoDAO.NapBCTongHopNL(maDV, tableName, loaiDM, cacThang, namDT,loaiMay, ref TongSoBG, ref listTH);
                ...
                if (cboLoaiDM.SelectedIndex == 1)
                    strLoaiDM += "- ( Theo định mức 1760/QĐ-ĐS ngày 03/11/2014 và điều chỉnh 1647/ĐS-VTĐM ngày 19/6/2015 ).";
                else
                    strLoaiDM += "- ( Theo định mức 1245/QĐ-ĐS ngày 19/9/2012 và điều chỉnh 1671/ĐS-VTĐM ngày 23/6/2015 ).";
                ...
                ShowReport("RptTongHopNL", "BaoCaoDS", listTH, rptParamList);
