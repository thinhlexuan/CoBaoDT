...
{
    public partial class BCNhapKhoForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        string loaiBC = string.Empty;       
        public BCNhapKhoForm()
        {
            ...
            string[] arRayNguondls = new string[] { "Theo phiếu nhập", "Theo trạm nl" };
            cboNhombc.Items.AddRange(arRayNguondls);
            cboNhombc.SelectedIndex = 0;
        }

        private void BCNhapKhoForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                int nguonDL = cboNhombc.SelectedIndex;
                int TongSoBG = 0;
                List<NL_BCNhapKho> listTH = new List<NL_BCNhapKho>();                             
                //Lấy dữ liệu
                BaoCaoDAO.NapBCNhapKhoTH(maDV, sdNgayBD.Value, sdNgayKT.Value, ref TongSoBG, ref listTH);
                ...
                FormHelper.ShowReport(reportViewer1, "RptBCNhapKhoTH", "BaoCaoDS", listTH, rptParamList);
