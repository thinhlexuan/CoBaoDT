...
{
    public partial class BCXuatKhoForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        string loaiBC = string.Empty;       
        public BCXuatKhoForm()
        {
            ...
            string[] arRayNguondls = new string[] { "Theo phiếu xuất", "Theo trạm nl" };
            cboNhombc.Items.AddRange(arRayNguondls);
            cboNhombc.SelectedIndex = 0;
        }

        private void BCXuatKhoForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                //Lấy dữ liệu
                BaoCaoDAO.NapBCXuatKhoTH(maDV, sdNgayBD.Value, sdNgayKT.Value, ref TongSoBG, ref listTH);
                ...
                FormHelper.ShowReport(reportViewer1, "RptBCXuatKhoTH", "BaoCaoDS", listTH, rptParamList);
