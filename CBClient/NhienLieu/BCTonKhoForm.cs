...
{
    public partial class BCTonKhoForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        ...
        private void BCTonKhoForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                //Lấy dữ liệu
                BaoCaoDAO.NapBCTonKho(strTram,maDauMo, sdNgayBD.Value, sdNgayKT.Value, ref TongSoBG, ref listTH);
                ...
                loaiBC += "-Trạm NL: " + cboTramNL.Text + "-Loại dầu mỡ: " + cboLoaiDM.Text;
                ...
                FormHelper.ShowReport(reportViewer1, "RptBCTonKho", "BaoCaoDS", listTH, rptParamList);
