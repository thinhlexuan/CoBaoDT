...
{
    public partial class BCTheKhoForm : DevComponents.DotNetBar.Metro.MetroForm
    {   
        ...
        private void BCTheKhoForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnTraTim_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                //Lấy dữ liệu
                BaoCaoDAO.NapBCTheKho(strTram,maDauMo, sdNgayBD.Value, sdNgayKT.Value, ref TongSoBG, ref listTH);
                ...
                FormHelper.ShowReport(reportViewer1, "RptBCTheKho", "BaoCaoDS", listTH, rptParamList);
