...
{
    public partial class XuatDoanThongForm : DevComponents.DotNetBar.Metro.MetroForm    {    
        
        public XuatDoanThongForm()
        {
        ...
        private void XuatDoanThongForm_Load(object sender, EventArgs e)
        {
            for (int i = 1; i <= 12; i++)
            {
